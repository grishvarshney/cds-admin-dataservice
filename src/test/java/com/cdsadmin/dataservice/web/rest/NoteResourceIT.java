...
public class NoteResourceIT {
    ...
    private static final String DEFAULT_NOTE_NO = "AAAAAAAAAA";
    private static final String UPDATED_NOTE_NO = "BBBBBBBBBB";
    ...
    public void createNote() throws Exception {
        ...
        assertThat(testNote.getNoteNo()).isEqualTo(DEFAULT_NOTE_NO);
        assertThat(testNote.getIndustry()).isEqualTo(DEFAULT_INDUSTRY);
        assertThat(testNote.getEffectiveDate()).isEqualTo(DEFAULT_EFFECTIVE_DATE);
        assertThat(testNote.getInstrumentType()).isEqualTo(DEFAULT_INSTRUMENT_TYPE);
    }
    ...
    public void getAllNotes() throws Exception {
        ...
        restNoteMockMvc.perform(get("/api/notes?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].noteNo").value(hasItem(DEFAULT_NOTE_NO)))
    ...
    public void getNote() throws Exception {
        ...
        restNoteMockMvc.perform(get("/api/notes/{id}", note.getId()))
            ...
            .andExpect(jsonPath("$.noteNo").value(DEFAULT_NOTE_NO))
    ...
    public void updateNote() throws Exception {
        ...
        Note testNote = noteList.get(noteList.size() - 1);
        assertThat(testNote.getNoteNo()).isEqualTo(UPDATED_NOTE_NO);
        assertThat(testNote.getIndustry()).isEqualTo(UPDATED_INDUSTRY);
        assertThat(testNote.getEffectiveDate()).isEqualTo(UPDATED_EFFECTIVE_DATE);
        assertThat(testNote.getInstrumentType()).isEqualTo(UPDATED_INSTRUMENT_TYPE);
    }
